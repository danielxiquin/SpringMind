...
export default function Parameters() {
  ...
  return (
    <section className="bg-[url(/FONDO1.png)] flex flex-col bg-cover bg-center min-h-screen p-6 gap-10">
        <div className="text-start flex flex-col">
            <h1 className="text-9xl font-[helvetic] leading-tight text-gray-900">INICIA</h1>
            <p className="text-2xl text-gray-900">Simula el comportamiento de un sistema masa-resorte-amortiguador</p>
        </div>
        ...
        <div className="w-full mx-auto">
            <div className="w-full flex flex-col items-end gap-1">
                ...
                <div className="flex gap-1">
                    ...
                    >
                    PARAMETROS <br /> NORMALIZADOS
                    </button>
                </div>

                {/* Tab Content */}
                <div className="bg-white p-8 w-220 rounded-md">
                    {activeTab === 'FISICOS' && (
                    <div>
                        {/* Header */}
                        <div className="flex flex-col justify-between items-start mb-12 gap-2">
                            <div className="text-right">
                                <p className="text-gray-600 mt-1 text-base text-justify">
                                    Ingresa los valores reales de tu sistema: masa, constante del resorte, amortiguamiento y fuerza externa. Ideal si estás resolviendo un problema con unidades físicas concretas.
                                </p>
                        ...
                        <div className="w-full space-y-8 flex gap-20">
                            <div className='w-full'>
                                <form className="p-4 space-y-3 flex flex-col gap-4 items-center" onSubmit={handleSubmitFisic}>
                                    <div className='space-y-3 w-full grid grid-cols-2 gap-4'>
                                        <div className='flex gap-2'>
                                            ...
                                            <input
                                                ...
                                                placeholder=""
                                                className="w-full p-2 bg-gray-200 rounded-md focus:ring-2 focus:ring-blue-400"
                                            />
                                        </div>
                                        <div className='flex gap-2'>
                                        ...
                                        <div className='flex gap-2'>
                                            ...
                                            <input
                                                ...
                                                onChange={handleChangeFisicos}
                                                placeholder=""
                                                className="w-full h-10 p-2 bg-gray-200 rounded-md focus:ring-2 focus:ring-blue-400"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <button 
                                      type="submit" 
                                      className="w-40 bg-gray-600 text-white py-2 rounded hover:bg-gray-700"
                                      disabled={loading}
                                    >
                    ...
                    <div>
                        {/* Header */}
                        <div className="flex flex-col gap-2 justify-between items-start mb-12">
                            <div className="text-right">
                                <p className="text-gray-600 mt-1 text-base text-justify">
                                    Trabaja con el sistema en su forma reducida: solo necesitas el factor de amortiguamiento β, la frecuencia natural ω₀ y la fuerza externa dividida entre la masa. Ideal para análisis teóricos o simulaciones.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="w-full space-y-8 flex gap-20">
                            <div className='w-full'>
                                <form className="p-4 space-y-3 flex flex-col gap-4 items-center" onSubmit={handleSubmitNorm}>
                                    <div className='space-y-3 w-full grid grid-cols-2 gap-4'>
                                        <div className='flex gap-2'>
